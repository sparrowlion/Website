...
const motionWorks = [
  {
    kind: 'video',
    src: '/media/text-animation.mp4',
    title: '文字动画实验',
    meta: 'Typography Motion / AE',
  },
  {
    kind: 'video',
    src: '/media/ae-opening.mp4',
    title: '京剧体验动画 · 首幕',
    meta: 'AE Motion / Opening Scene',
  },
  {
    kind: 'video',
    src: '/media/ae-ending.mp4',
    title: '京剧体验动画 · 终幕',
    meta: 'AE Motion / Ending Scene',
  },
  {
    kind: 'image',
    src: '/media/c4d-room.png',
    title: 'C4D 室内空间与材质',
    meta: 'Cinema 4D / Interior Scene',
  },
  {
    kind: 'image',
    src: '/media/c4d-process.png',
    title: 'C4D 建模过程',
    meta: 'Cinema 4D / Process Capture',
  },
  {
    kind: 'image',
    src: '/media/pathfinder-mine.png',
    title: '探路者角色展示',
...
const xiyunMedia = Array.from({ length: 15 })
  ...
  .map((number) => ({
    kind: 'image',
    src: `/media/xiyun-ppt-${String(number).padStart(2, '0')}.png`,
...
const chillaxMedia = [
  {
    kind: 'image',
    src: '/media/chillax-story-01.png',
    title: '深呼吸 / 全黑与琥珀光点',
    meta: '0:00 - 0:07',
  },
  {
    kind: 'image',
    src: '/media/chillax-story-02.png',
    title: '琥珀粒子缠绕高脚椅',
    meta: '00:31 / Sax Response',
  },
  {
    kind: 'image',
    src: '/media/chillax-story-03.png',
    title: '深蓝重力波',
    meta: '00:52 / Bass Layer',
  },
  {
    kind: 'image',
    src: '/media/chillax-story-04.png',
    title: '粒子漩涡汇聚麦克风',
    meta: '01:12 - 01:20',
  },
  {
    kind: 'image',
    src: '/media/chillax-story-05.png',
    title: '代码矩阵墙爆发',
    meta: '1:20 - 1:40',
  },
];
    ...
    <section className="hero" id="home" style={{ '--scroll': progress }}>
      ...
      <div className="hero-stage">
        ...
        <div className="hero-visual-wrap">
          ...
          <img className="griffin" src="/griffin.png" alt="银白色数字风格翼兽主视觉" />
        </div>
